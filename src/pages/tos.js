...
const PrivacyPage = () => {
  return (
    <Layout>
      ...
      <p>
        By accessing this Website, accessible from https://overlayed.dev, you
      ...
      <p>
        ...
        on overlayed's Website for personal, non-commercial transitory viewing
      ...
      <ul>
        ...
        <li>
          attempt to reverse engineer any software contained on overlayed's
          Website;
        </li>
        <li>
      ...
      <p>
        This will let overlayed to terminate upon violations of any of these
      ...
      <p>
        All the materials on overlayed’s Website are provided "as is". overlayed
        makes no warranties, may it be expressed or implied, therefore negates
        all other warranties. Furthermore, overlayed does not make any
      ...
      <p>
        overlayed or its suppliers will not be hold accountable for any damages
        that will arise with the use or inability to use the materials on
        overlayed’s Website, even if overlayed or an authorize representative of
      ...
      <p>
        The materials appearing on overlayed’s Website may include technical,
        typographical, or photographic errors. overlayed will not promise that
        any of the materials in this Website are accurate, complete, or current.
        overlayed may change the materials contained on its Website at any time
        without notice. overlayed does not make any commitment to update the
        materials.
      </p>
      ...
      <p>
        overlayed has not reviewed all of the sites linked to its Website and is
        not responsible for the contents of any such linked site. The presence
        of any link does not imply endorsement by overlayed of the site. The use
      ...
      <p>
        overlayed may revise these Terms of Use for its Website at any time
      ...
      <p>
        Any claim related to overlayed's Website shall be governed by the laws
